...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/604cc79e832b6c0017f0f127
...
To start editing your site, you can use the Sanity interface at https://zolotoy-cc79e.sanity.studio/.
...
Generated at `2021-03-13T14:15:07.812Z` by Stackbit version `0.3.50`.